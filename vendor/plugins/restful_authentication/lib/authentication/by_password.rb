  ...
  module ByPassword
    ...
    def self.included(recipient)
      ...
      recipient.class_eval do
        ...
        validates_presence_of :password, :if => :password_required?, :message => "Where's your password?"
        validates_presence_of :password_confirmation, :if => :password_required?,
          :message => "Did someone saw this field's value?"
        validates_confirmation_of :password, :if => :password_required?, :message => "Beh! It doesn't match!",
          :allow_blank => true
